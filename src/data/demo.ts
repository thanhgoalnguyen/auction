...
export const SHOW_MORE_POLICY_TERM = [
	ROUTE_PATH?.EMAIL_PASSWORD_SETTING,
	ROUTE_PATH?.LIKE_LIST,
	ROUTE_PATH?.MY_PAGE,
	ROUTE_PATH?.PERSONAL_INFORMATION_SETTING,
	ROUTE_PATH?.SHIPPING_ADDRESS_LIST,
	ROUTE_PATH?.SHIPPING_ADDRESS_REGISTRATION,
	ROUTE_PATH?.USER_PROFILE_SETTING,
	ROUTE_PATH?.VIEW_HISTORY,
]

export const HIDDEN_LIST_POLICY_TERM = [
	ROUTE_PATH?.FOLLOW_LIST,
	ROUTE_PATH?.OTHER_PROFILE,
	ROUTE_PATH?.WON_ITEM_LIST,
	ROUTE_PATH?.POSTED_ITEM_LIST
]

export const HIDDEN_COPYRIGHT_POLICY_TERM = [
	ROUTE_PATH?.FOLLOW_LIST,
	ROUTE_PATH?.WON_ITEM_LIST,
	ROUTE_PATH?.POSTED_ITEM_LIST
]
