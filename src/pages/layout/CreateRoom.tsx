		...
		<div className="create-room-page page-container flex flex-col items-center w-full h-max">
			...
			<div className="container flex flex-col">
				...
				<div className="flex flex-col gap-3 pb-6 mb-11 border-b border-neutral-300">
					...
					<p className="text-[11px] leading-[13px] text-neutral-500 [&_span]:p-[1px] [&_span]:border [&_span]:border-neutral-700"><span>2026</span>年<span>4</span>月<span>10</span>日 <span>20</span> : <span>00</span>ごろ〜</p>
					<div className="flex items-center gap-5">
						<p className="p-[1px] text-[11px] leading-[13px] text-neutral-500 border border-neutral-700">120分間</p>
