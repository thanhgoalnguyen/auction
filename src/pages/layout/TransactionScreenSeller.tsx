...
import Step2 from '@/components/ui/transactionScreenSeller/Step2';
import Step3 from '@/components/ui/transactionScreenSeller/Step3';
import Step4 from '@/components/ui/transactionScreenSeller/Step4';
import Step5 from '@/components/ui/transactionScreenSeller/Step5';

import { ROUTE_PATH } from '@/data/demo';

export default function TransactionScreenSeller() {
	const listStep = [
		{
			component: "",
			id: 1,
